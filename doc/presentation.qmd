...
<div style="display: flex; align-items: flex-start; justify-content: space-between;">
  <div>
    <h3>Pourquoi un Snake ?</h3>
    <ul>
      <li>Volonté de faire du développement en Julia</li>
      <li>Jeu (à priori...) simple et amusant</li>
    </ul>
  </div>
  <div style="text-align: right;">
    <p style="font-size: 80%; font-weight: bold;">Problèmes rencontrés:</p>
    <ul style="font-size: 80%;">
      <li>Affichage</li>
      <li>Déplacements</li>
      <li>Bugs persistants</li>
    </ul>
  </div>
</div>
---
